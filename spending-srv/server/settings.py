...
"""
DEPLOYMENT: This file should not be overwritten by deployment scripts
"""
...
SECRET_KEY = '#on4k_&9$7sjcqtq&p15cqz$f*5ra#9d57)4_9in42x*i4=_^p'
...
INSTALLED_APPS = [
    ...
    'corsheaders',
    'spending_api.apps.SpendingConfig',
    'rest_framework'
]
...
# the sample workspace that is copied if the user goes into a demo
